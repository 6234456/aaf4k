...
class DevelopmentOfAccount(data: List<Map<String, *>>, entityName: String, projectName: String, workingPaperName: String, processedBy: String, theme: Theme? = Theme.BLOOD) : Template(
        headings = listOf(
                HeadingFormat(value = "Nr.", formatData = ExcelUtil.DataFormat.STRING.format),
                ...
                HeadingFormat(value = "Endebestand", formatData = ExcelUtil.DataFormat.NUMBER.format, dataAggregatable = true)
        ),
        theme = theme,
        data = data,
