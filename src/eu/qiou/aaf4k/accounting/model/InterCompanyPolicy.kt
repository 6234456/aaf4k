...
data class InterCompanyPolicy(
    ...
    companion object {
        fun eliminate(context: Map<ProtoEntity, Map<ProtoEntity, Map<InterCompanyPolicyType, List<InterCompanyPolicy>>>>, reporting: Reporting) {
            ...
            val visited: MutableMap<ProtoEntity, MutableList<ProtoEntity>> = mutableMapOf()
